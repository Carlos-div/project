...
<template>
    <div class="relative font-montserrat font-extrabold text-gray-900 snap-item z-10" id="section5">
        ...
        <h1 class="relative text-4xl md:text-5xl xl:text-6xl pt-24">Locaciones de nuestras 3 corporaciones</h1>
        <div>
            <div class="grid grid-cols-3 pl-12 pt-16">
                <!--LOMA-->
                    <a href="https://maps.app.goo.gl/SGeAibzHZSw7hYzCA" target="_blank">
                        <div class="relative flex flex-col sm:flex-col shadow-2xl rounded-lg overflow-hidden transition-transform transform hover:scale-75 duration-300 ease-in-out w-24 md:w-48 lg:w-72 xl:w-96 p-6 cursor-pointer">
                        <p class="sm:text-xs md:text-2xl mb-4">CUSAEM LOMA</p>
                ...
                <!--AUXILIAR-->
            <a href="https://maps.app.goo.gl/etgy7Cc8QjAs63Ub6" target="_blank">
                <div class="relative flex flex-col sm:flex-col shadow-2xl rounded-lg overflow-hidden transition-transform transform hover:scale-75 duration-300 ease-in-out w-24 md:w-48 lg:w-72 xl:w-96  p-6">
                    <p class="sm:text-xs md:text-2xl mb-4">CUSAEM AUXILIAR</p>
                    <div class="w-auto h-0 pb-[100%] relative">
                ...
                <!--LERMA-->
                <a href="https://maps.app.goo.gl/NqnQwksBR6hqiThZ8" target="_blank">      
                    <div class="relative flex flex-col sm:flex-col shadow-2xl rounded-lg overflow-hidden transition-transform transform hover:scale-75 duration-300 ease-in-out w-24 md:w-48 lg:w-72 xl:w-96  p-6">
                        <p class="sm:text-xs md:text-2xl mb-4">CUSAEM LERMA</p>
                        <div class="w-auto h-0 pb-[100%] relative">
                        ...
                        <p class="mt-4 md:text-xl">Del Parque 100, Parque Industrial, 52000 Lerma de Villada, Méx.</p>
                    </div>
                </a>  
            </div>
        </div>
